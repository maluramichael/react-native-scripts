...
bundleIdentifier="" # de.mycompany.myawesomeappstaging
apkName="" # MyAwesomeAppStaging without .apk
appDestination="" # final destination for your app. $HOME/Desktop/Apps/MyAwesomeApp/Staging
gradlewCommand="" # assembleStaging
# -------------------------------------------------------------------------
# -------------------------------------------------------------------------
